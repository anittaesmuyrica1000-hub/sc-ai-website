      ...
      <section className="proof2" id="proof">
        <div className="wrap">
          ...
          <div className="proof-row">
            <div className="pc2"><div className="vlabel"><i className="fa-solid fa-stopwatch"></i> 속도</div><div className="big big-phrase">수천 명<br />동시 검토</div><p>지원자가 몰려도 1차 검토가 밀리지 않습니다.</p></div>
            <div className="pc2"><div className="vlabel"><i className="fa-solid fa-coins"></i> 비용 절감</div><div className="big big-phrase">불필요한<br />면접 감소</div><p>검증된 후보에 면접 리소스를 집중합니다.</p></div>

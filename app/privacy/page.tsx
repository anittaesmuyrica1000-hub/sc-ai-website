  ...
  return (
    <main className="legal">
      <div className="legal-head">
        ...
        <p className="legal-version">시행일 2026년 6월 29일 · 최종 업데이트 2026년 6월 30일</p>
      </div>

      <p>AI 면접 제품(지원자)의 인앱(in-product) 처리에 대해서는 별도의 「AI 면접 개인정보 고지」가 우선 적용됩니다.</p>
      ...
      <div style={{ overflowX: "auto" }}>
        <table>
          ...
          <tbody>
            <tr>
              <td><strong>Microsoft Corporation</strong> — Azure(인프라)</td>
              <td>컴퓨팅, 스토리지(Blob·Files), 네트워킹, Postgres 호스팅. 플랫폼의 기본 데이터 저장 계층.</td>
              <td>전 항목: 미디어, 면접 데이터, 사용자 계정, 사용자 로그, 접근 로그, 결제.</td>
              <td>한국 중부(Microsoft Azure Korea 리전)</td>
              <td>Microsoft Online Services 데이터 보호 부속서(DPA) — EU 표준계약조항(SCC)·영국 부속서·한국 국외이전 부속 포함.</td>
            </tr>
            <tr>
              <td><strong>Microsoft Corporation</strong> — Azure OpenAI Service</td>
              <td>면접 리포트 생성, 요약, 지원자 역량 평가, 이력서 기반 질문 생성, 실시간 후속 질문을 위한 대규모 언어모델 추론.</td>
              <td>면접 전사본 및 이력서 텍스트. 지원자 음성은 전송되지 않음(음성은 Azure AI Services가 먼저 전사).</td>
              <td>한국 중부(Microsoft Azure Korea 리전)</td>
              <td>Microsoft Online Services DPA + Azure OpenAI Service 약관. Microsoft 공개 정책에 따라 고객의 프롬프트·완성결과는 Microsoft 기반모델의 학습·재학습·개선에 사용되지 않음.</td>
            </tr>
            <tr>
              <td><strong>Microsoft Corporation</strong> — Azure AI Services(음성-텍스트 변환)</td>
              <td>면접 음성의 텍스트 변환. 순수 STT이며 평가·의견 없음.</td>
              <td>면접 음성 및 변환된 텍스트.</td>
              <td>한국 중부(Microsoft Azure Korea 리전)</td>
              <td>Microsoft Online Services DPA(1·2행과 동일 업체).</td>
            </tr>
            <tr>
              <td><strong>Agora Lab, Inc.</strong></td>
              <td>실시간 면접 세션 중 영상·음성 중계. Azure Blob 스토리지로의 청크 업로드 파이프라인. 전송 전용 역할이며 평가·의견 없음.</td>
              <td>세션 중 면접 음성·영상 스트림(일시적; 짧은 엣지 캐시 외 저장되지 않음).</td>
              <td>Agora SD-RTN 엣지·데이터센터(최근접 엣지 모델; 세션별 라우팅 리전 동적).</td>
              <td>Agora Master Services Agreement + Agora Data Processing Addendum(<a href="https://www.agora.io/en/legal/data-processing-agreement" target="_blank" rel="noopener noreferrer">agora.io/en/legal/data-processing-agreement</a> 게시).</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <p style={{ marginTop: "36px", paddingTop: "20px", borderTop: "1px solid var(--line)", color: "var(--slate-2)", fontSize: ".92em" }}>시행일: 2026년 6월 29일 · 최종 업데이트: 2026년 6월 30일</p>

...
const KB: KbItem[] = [
  ...
  { q: "AI 면접이 사람 면접을 완전히 대체하나요?", a: "1차 검토와 지원자 선별을 자동화해 채용팀의 시간을 아껴줍니다. 검증을 통과한 핵심 인재 리포트만 전달되며, 최종 판단은 채용팀이 직접 내립니다.", k: ["대체", "사람", "최종", "판단", "선별", "1차"] },
  ...
  { q: "기존 ATS·채용 툴과 연동되나요?", a: "리포트는 표준 형식으로 제공되어 기존 채용 프로세스에 바로 활용할 수 있습니다. 상세 연동 방식은 도입 상담에서 안내해 드려요.", k: ["ats", "연동", "툴", "통합", "연결", "시스템"] },
  ...
  { q: "비용은 어떻게 되나요?", a: "채용 규모와 활용 방식에 맞춰 책정됩니다. 우선 무료로 도입 효과를 확인해 보신 뒤 상담을 통해 안내해 드려요.", k: ["비용", "가격", "요금", "견적", "얼마"] },
...
export default function Chatbot() {
  ...
  function openPanel() {
    ...
    // 모바일에서는 자동 포커스하지 않는다(키보드가 올라와 인사말·빠른질문을 가림).

...
type KbItem = { q: string; a: string; k: string[]; quick?: boolean };
const KB: KbItem[] = [
  { q: "AI 면접은 어떻게 진행되나요?", a: "지원자는 안내에 따라 온라인으로 AI 면접에 응시합니다. AI 면접이 응답을 분석·검증해 역량 평가와 핵심 요약이 담긴 리포트를 만들고, 채용팀에는 검증을 통과한 상위 후보의 리포트만 전달됩니다.", k: ["면접", "진행", "어떻게", "응시", "방식", "절차"], quick: true },
  { q: "리포트에는 어떤 내용이 담기나요?", a: "인터뷰 핵심 요약, 종합 등급, 역량 차트(의사소통·문제해결·직무 지식·협업·태도·성실성), 강점·약점 분석이 담깁니다. 긴 영상을 다시 보지 않아도 지원자가 어떤 사람인지 한눈에 파악할 수 있어요.", k: ["리포트", "결과", "보고서", "차트", "등급", "역량", "요약", "강점", "약점", "내용"], quick: true },
  { q: "AI 면접이 사람 면접을 완전히 대체하나요?", a: "1차 검토와 지원자 선별을 자동화해 채용팀의 시간을 아껴줍니다. 검증을 통과한 핵심 인재 리포트만 전달되며, 최종 판단은 채용팀이 직접 내립니다.", k: ["대체", "사람", "최종", "판단", "선별", "1차"], quick: true },
  ...
  { q: "기존 ATS·채용 툴과 연동되나요?", a: "리포트는 표준 형식으로 제공되어 기존 채용 프로세스에 바로 활용할 수 있습니다. 상세 연동 방식은 도입 상담에서 안내해 드려요.", k: ["ats", "연동", "툴", "통합", "연결", "시스템"], quick: true },
  { q: "지원자 데이터는 안전한가요?", a: '모든 데이터는 전송 구간 암호화(HTTPS)와 접근 통제 정책 아래 안전하게 관리됩니다. 수집 항목과 처리 방식은 <a href="/privacy">개인정보처리방침</a>에서 확인하실 수 있어요.', k: ["데이터", "보안", "안전", "개인정보", "보호", "암호화"], quick: true },
  { q: "무료로 먼저 써볼 수 있나요?", a: '네, 설치나 계약 없이 무료로 도입 효과를 먼저 확인하실 수 있어요. <a href="/apply">도입 문의</a>를 남기시면 영업일 기준 1일 내 데모와 함께 안내드립니다.', k: ["무료", "체험", "테스트", "시범", "데모", "trial"], quick: true },
  { q: "도입까지 얼마나 걸리나요?", a: "설치나 계약 없이 무료 신청 후 바로 시작할 수 있습니다. 신청하시면 영업일 기준 1일 내 담당자가 데모와 함께 안내드려요.", k: ["도입", "기간", "얼마나", "시작", "언제", "소요"] },
  { q: "비용은 어떻게 되나요?", a: "채용 규모와 활용 방식에 맞춰 책정됩니다. 우선 무료로 도입 효과를 확인해 보신 뒤 상담을 통해 안내해 드려요.", k: ["비용", "가격", "요금", "견적", "얼마"], quick: true },

...
picture("admin-gate.png", "그림 10. 관리자 콘솔 로그인 게이트 — Google 계정 + 관리자 화이트리스트 검증 (내부 화면은 보안상 로그인 후 열람)")
...
picture("blog-list.png", "그림 11. 블로그 목록 페이지(/blog) — 카테고리 필터·검색")
picture("blog-list-2.png", "그림 12. 블로그 목록 — 자체 제작 커버 이미지 기반 콘텐츠 카드")
picture("blog-post.png", "그림 13. 블로그 상세 페이지 — 게재 콘텐츠 예시")
picture("blog-post-2.png", "그림 14. 블로그 상세 — 본문 게재 화면")
...
picture("ga4-daily-sessions.png", "그림 15. GA4 일별 세션 추이 (2026.07.08~08.12, 일일 애널리틱스 리포트 집계) — 점선: 쿠키 동의 배너 도입 시점", width=6.4)
...
picture("ga4-snapshot.png", "그림 16. GA4 보고서 홈 — 최근 30일 활성 사용자 413명·세션 630건 (캡처일 2026.08.13)")
picture("ga4-channels.png", "그림 17. GA4 트래픽 획득 보고서 — 세션 소스/매체별 추이 (2026.05.01~08.12)")
picture("looker-dashboard.png", "그림 18. Looker Studio 성과 대시보드 'Supercoder 웹 애널리틱스' — 트래픽 현황 페이지")
